...
if(isset($_POST['Edit'])) {
  ...
  if(empty($nama))
    {
      mysqli_query($connection, " UPDATE hotel SET hotel_nama = '$hotelnama', hotel_ID = '$hotelkode'
      WHERE hotel_ID = '$hotelkode' ");
  ...
  if(($ekstensifile == "jpg") or ($ekstensifile == "JPG")) 
  {
    ...
    mysqli_query($connection, "UPDATE hotel SET hotel_nama = '$hotelnama', hotel_ID = '$hotelkode',
    hotel_foto = '$nama' WHERE hotel_ID = '$hotelkode' ");
    header("location:hotel.php");
  }

  mysqli_query($connection,"UPDATE hotel SET hotel_nama = '$hotelnama', hotel_alamat = '$hotelalamat', 
  hotel_keterangan = '$hotelket', hotel_foto = '$nama', area_ID	= '$areahotel' WHERE hotel_ID = '$hotelkode'");
  header("location:hotel.php");
}
...
$kodehotel = $_GET["ubah"];
$edithotel = mysqli_query($connection, "SELECT * FROM hotel WHERE hotel_ID = '$kodehotel' ");
  ...
  <div class="row">
    ...
    <div class="col-sm-10">
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          <h1 class="display-4">Edit Nama Hotel</h1>
        </div>
      ...
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="kode_kategori" name="input_kode" placeholder="Kode Hotel"
            maxlength="4" value="<?php echo $rowedit["hotel_ID"]; ?>">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            ...
            value="<?php echo $rowedit["hotel_nama"]; ?>">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            ...
            value="<?php echo $rowedit["hotel_alamat"]; ?>">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            ...
            value="<?php echo $rowedit["hotel_keterangan"]; ?>">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          <label for="file" class="col-sm-2 col-form-label">Foto Hotel</label>
            <div class="col-sm-10">
              ...
              <img src="images/<?php echo $rowedit['hotel_foto']; ?>" style="width: 200px; height: 100px;">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            ...
            <option value="<?php echo $rowedit["hotel_ID"]; ?>"><?php echo $rowedit["hotel_ID"]; ?>
