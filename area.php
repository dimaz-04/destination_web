...
<?php
	...
	if(isset($_POST['Simpan']))
	{
		...
		mysqli_query($connection, "insert into area  values ('$areakode', '$areanama','$alamat','$keteranganarea','$kodekabupaten' )");
...
<form method="POST">
	<div class="form-group row mb-2">
		...
		{
			$search = $_POST['search'];
			$query = mysqli_query($connection, "select area.*, area.area_ID, area.area_nama, area.area_wilayah, area.area_keterangan, kabupaten.kabupaten_KODE, kabupaten.kabupaten_NAMA, kabupaten.kabupaten_ALAMAT 
				from area, kabupaten 
				where area_nama like '%".$search."%'
