...
<?php
  ...
  if(isset($_POST['Edit'])) {
    ...
    mysqli_query($connection,"UPDATE dimas SET dimasNEGARA = '$destinasinama', destinasi_ID = '$destinasikodeID'
    WHERE dimasID = '$dimaskode'");
  ...
  $kodeubahdimas = $_GET["ubah"];
  $editdimas = mysqli_query($connection, "SELECT * FROM dimas WHERE dimasID = '$kodeubahdimas' ");
  $rowedit = mysqli_fetch_array($editdimas);

  $editdimas = mysqli_query($connection, "SELECT * FROM dimas, destinasi 
  WHERE dimasID = '$kodeubahdimas' and dimas.destinasi_ID = destinasi.destinasi_ID ");

  $rowedit2 = mysqli_fetch_array($editdimas);  
...
<head>
  ...
  <div class="row">
    ...
    <div class="col-sm-10">
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          <h1 class="display-4">Edit Tabel Dimas</h1>
        </div>
      ...
      <form method="POST" action="">
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="kode_destinasi" name="input_kode" placeholder="kode" 
            value="<?php echo $rowedit["dimasID"]; ?>" maxlength="4">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            ...
            value="<?php echo $rowedit["dimasNEGARA"]; ?>">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            ...
            <option value="<?php echo $rowedit["destinasi_ID"]; ?>"><?php echo $rowedit["destinasi_ID"]; ?>
          ...
          // }
            ...
            { ?>
              <tr>
                ...
                <td>
                  <a href="indexedit.php?ubah=<?php echo $row["destinasi_ID"];?>" class="btn btn-success btn-sm" title="EDIT">
                ...
                <td>
                  <a href="indexhapus.php?hapus=<?php echo $row["destinasi_ID"];?>" class="btn btn-danger btn-sm" title="DELETE">
