    ...
    <div class="col-sm-10">
      ...
      <form method="POST" action="">
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="kode_destinasi" name="input_kode" placeholder="kode Destinasi" maxlength="4">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="nama_destinasi" name="input_nama" placeholder="Nama Destinasi">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="alamat_destinasi" name="input_alamat" placeholder="Alamat Destinasi">
          </div>
        </div>
