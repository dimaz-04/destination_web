...
<?php
  ...
  if(isset($_POST['Simpan'])) {
    ...
    if(($ekstensifile == "jpg") or ($ekstensifile == "JPG")) 
    {
      ...
      mysqli_query($connection, "INSERT INTO kabupaten VALUES ('$kodekab', '$kabupatennama', '$kabupatenalamat', '$ketkabupaten', '$nama', '$ketfoto')");
    ...
    <div class="col-sm-10">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="kode_destinasi" name="input_kode" placeholder="kode Kabupaten" maxlength="4">
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="ketfoto" name="input_ketfot" placeholder="Keterangan Foto">
          </div>
        </div>
